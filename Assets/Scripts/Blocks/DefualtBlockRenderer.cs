...
public class DefualtBlockRenderer : IBlockRenderer
{
    ...
    public void Render(BlockRenderContext context, Vector3Int pos, IMeshBuilder meshBuilder)
    {
        ...
        int[] neighbors =
        {
            ...
            pos.y == Chunk.SIZE_Y_MINUS_ONE ? 0 : context.chunk[pos.x, pos.y + 1, pos.z],
            pos.y == 0 ? 0 : context.chunk[pos.x, pos.y - 1, pos.z],
            pos.z == Chunk.SIZE_Z_MINUS_ONE ? context.neighbors[2][pos.x, pos.y, 0] : context.chunk[pos.x, pos.y, pos.z + 1],
            pos.z == 0 ? context.neighbors[3][pos.x, pos.y, Chunk.SIZE_Z_MINUS_ONE] : context.chunk[pos.x, pos.y, pos.z - 1]
        };
